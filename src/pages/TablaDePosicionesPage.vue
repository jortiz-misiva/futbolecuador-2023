...
import TablaPosiciones from '@/shared/components/tablas/TablaPosiciones.vue';
  ...
  <FutecPage>
    <template v-slot:header>
      <AdComponent
        ...
        adid="div-gpt-ad-1667236395933-0"
    ...
    <TitleSection title="Tabla de Posiciones LigaPro Bet593" class="q-mt-sm" />
    <TablaPosiciones />
    ...
    <template v-if="!isLoading">
      ...
      <NoticiaSecundaria
        class="q-my-sm"
        v-for="noticia in masleidas"
        :key="noticia.id"
        :noticia="noticia"
    /></template>
    <TaboolaWidget
      tid="taboola-below-posiciones"
      placement="Below posiciones"
